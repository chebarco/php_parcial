<?PHP
$productoSeleccionado = $_GET['vit'] ?? FALSE;

$titulo = strtoupper(str_replace("ms ", "ms. ", str_replace("_", " ", $productoSeleccionado)));

require_once "./classes/Catalogo.php";
$objetoVitamina = new  Catalogo();
$catalogoxVitamina = $objetoVitamina->catalogoPorCategoria($productoSeleccionado);
...
<div class=" d-flex justify-content-center p-5">
    <div>
        <h1 class="text-center mb-5 fw-bold">Las vitaminas que tu cuerpo necesitan
        </h1>
        <div class="container">
            <div class="row row-cols-1 row-cols-md-3 g-4">

                <?php foreach ($catalogoxVitamina as $producto) { ?>
